...
export const adminAgentTransport: AdminAgentTransport =
  async function* adminAgentTransport(request) {
...
type OmitProviderTransport = (
  request: Omit<AdminAgentChatRequest, 'providerId'>,
) => AsyncIterable<AiAgentSseEvent>
