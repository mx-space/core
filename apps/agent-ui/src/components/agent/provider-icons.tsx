...
export function OpenRouterIcon({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path d="M12 2C6.5 2 2 6.5 2 12" strokeDasharray="4 3" />
...
export function AnthropicIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <path d="M17.304 3.541h-3.672l6.696 16.918h3.672zm-10.608 0L0 20.459h3.744l1.38-3.6h7.031l1.38 3.6h3.744L10.584 3.541zm.144 10.236L9.072 7.32l2.232 6.457z" />
    </svg>
  )
}
