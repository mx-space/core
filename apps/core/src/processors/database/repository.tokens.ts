...
export const POSTGRES_REPOSITORY_TOKENS = {
  ...
  corpusEmbedding: Symbol('CorpusEmbeddingRepository'),
  personaProfile: Symbol('PersonaProfileRepository'),
  aiMemory: Symbol('AiMemoryRepository'),
  aiEcho: Symbol('AiEchoRepository'),
