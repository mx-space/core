export enum AppErrorCode {
  ...
  // image generation
  IMAGE_GENERATION_DISABLED = 'IMAGE_GENERATION_DISABLED',
  ...
  DRAFT_HEAD_CONFLICT = 'DRAFT_HEAD_CONFLICT',
  DRAFT_SHARE_NOT_FOUND = 'DRAFT_SHARE_NOT_FOUND',
  PUBLISHED_REVISION_CHANGED = 'PUBLISHED_REVISION_CHANGED',
  ...
  MEMBERSHIP_PROVIDER_NOT_CONFIGURED = 'MEMBERSHIP_PROVIDER_NOT_CONFIGURED',
  MEMBERSHIP_PROVIDER_NOT_SUPPORTED = 'MEMBERSHIP_PROVIDER_NOT_SUPPORTED',
  MEMBERSHIP_ALREADY_ACTIVE = 'MEMBERSHIP_ALREADY_ACTIVE',
  MEMBERSHIP_APPLE_TRANSACTION_INVALID = 'MEMBERSHIP_APPLE_TRANSACTION_INVALID',
  MEMBERSHIP_APPLE_ALREADY_BOUND = 'MEMBERSHIP_APPLE_ALREADY_BOUND',
  PREMIUM_REQUIRES_LEXICAL = 'PREMIUM_REQUIRES_LEXICAL',
  ARTICLE_PURCHASE_UNAVAILABLE = 'ARTICLE_PURCHASE_UNAVAILABLE',
  ARTICLE_NOT_PURCHASABLE = 'ARTICLE_NOT_PURCHASABLE',
  ARTICLE_ALREADY_PURCHASED = 'ARTICLE_ALREADY_PURCHASED',
  ...
  SNIPPET_SKILL_INVALID_FRONTMATTER = 'SNIPPET_SKILL_INVALID_FRONTMATTER',
  SNIPPET_SKILL_NAME_MISMATCH = 'SNIPPET_SKILL_NAME_MISMATCH',
  SNIPPET_SKILL_DESCRIPTION_REQUIRED = 'SNIPPET_SKILL_DESCRIPTION_REQUIRED',
