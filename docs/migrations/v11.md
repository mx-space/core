# Upgrading to Mix Space v11

Mix Space v11 refactors the Aggregate API by splitting categories and pages out of the aggregate endpoint and adding a lightweight site metadata endpoint. This guide will help you complete the upgrade.
...
- [Mix Space changelog](../../apps/core/CHANGELOG.md)
