...
describe('mxs project CRUD against real core', () => {
  ...
  it('creates, lists, gets, updates, and deletes a project', async () => {
    ...
    const listed = await runMxs(['--json', 'project', 'list'], env())
